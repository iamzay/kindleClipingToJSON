...
DataCollector.prototype.collect=function collect(cliping) {
...
DataCollector.prototype.getPosition=function getPosition(positionLine) {
    var pattern=/#(\d+)/;
    var pattern2=/(\d+)/;
...
DataCollector.prototype.getDate=function getDate(dateLine) {
    if (dateLine[0]==='A') {
...
DataCollector.prototype.getDateFromEng=function getDateFromEng(dateLine) {
    var map= {
        January:'01',
        February:'02',
        March:'03',
...
DataCollector.prototype.getDateFromChn=function getDateFromChn(dateLine) {
...
DataCollector.prototype.getTime=function getTime(timeLine) {
...
DataCollector.prototype.getTimeFromEng=function getTimeFromEng(timeLine) {
...
DataCollector.prototype.getTimeFromChn=function getTimeFromChn(timeLine) {
...
DataCollector.prototype.getContent=function getContent(contentLine) {
    return contentLine;
};

DataCollector.prototype.getTitleAuthor=function getTitleAuthor(titleLine) {
    var cnt=1;
...
DataCollector.prototype.normalizeData=function normalizeData(data) {
